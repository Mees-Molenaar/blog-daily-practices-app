...
class HardcodedPracticesApi extends PracticesApi {
  final StreamController<List<Practice>> _practicesStreamController =
  ...
  Stream<List<Practice>> getPractices() {
    ...
    _practicesStreamController.add(practices);

    return _practicesStreamController.stream;
  }

  void dispose() {
    _practicesStreamController.close();
  }
}
